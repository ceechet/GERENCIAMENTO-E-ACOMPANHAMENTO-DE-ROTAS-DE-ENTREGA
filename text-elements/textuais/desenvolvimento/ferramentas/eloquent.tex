...
Segundo \citeonline{stauffer2017desenvolvendo}, o Eloquent ORM implementa o ActiveRecord, o que significa que uma única classe (\textit{model}) é responsável por interagir com a tabela de forma completa, podendo inserir, atualizar e excluir novos registros.