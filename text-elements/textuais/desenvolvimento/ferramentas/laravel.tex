...
%%% Rev-Madalozzo: Não li todo o texto ainda, mas acho que poderia explorar mais o laravel. Falando do EloquentORM, do Artisan, do Kernel que ele tem, do conceito de rotas, etc. Este texto está ok, o problema é q ele está marketeiro (querendo vender a ideia), falta o pq ele eh bom.